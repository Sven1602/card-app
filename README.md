...
3. Übergabe eines Image an den Header. (über Input() Variable)
...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/24QFwofWn4)
...
```sh
npx nx serve card-app
```

To create a production bundle:

```sh
npx nx build card-app
```

To see all available targets to run for a project, run:

```sh
npx nx show project card-app
```
